...
section:after {
  ...
  clear: both;
	...
	<ul class="nav nav-pills nav-stacked">
        ...
        <li  class="active"><a href="#">ADD NEW BUS</a></li>
                    ...
                    <form  method="post" action="add_bus2.jsp">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">                            
                            <div class="form-group">
                               ...
                               <input type="time" id="appt" name="dtime" required>
                            </div>
                        </div>
                        </div>
                        <!-- dob end -->
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">                            
                            <div class="form-group">
                               ...
                               <input type="time" id="appt" name="atime" required>
                            </div>
                        </div>
                        </div>
                        <!--  age start -->
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="from" class="input-md input-rounded form-control" placeholder="From" required>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">                            
                            <div class="form-group">
                                <input type="text" name="to" class="input-md input-rounded form-control" placeholder="To" required>
                            </div>
                        </div>
                        </div>
                        <!-- student end -->
                        ...
                        <div class="col-md-2 col-sm-5 col-xs-6">                            
                            <div class="form-group ml30">
                                ...
                                <input type="radio" name="type" id="R1" value="AC" required>
                        ...
                        <div class="col-md-3 col-sm-5 col-xs-1">
                            <div class="form-group ml30">
                                ...
                                <input type="radio" name="type" id="R2" value="Non AC" required>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                <input type="number" name="distance"  class="input-md input-rounded form-control" placeholder="distance" required>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                <input type="number" name="chargeamount"  class="input-md input-rounded form-control" placeholder="charge amount" required>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                <input type="number" name="noseats"  class="input-md input-rounded form-control" placeholder="number of seats" maxlength="10" required >
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-9">
                             ...
                             <div class="col-md-2 col-sm-10 col-xs-12 text-center">
                                 <button type="submit"  class="button-3d button-lg button-pasific hover-ripple-out mt20 center-block">ADD</button>
                        </div>
