...
<table class="table">
   ...
   %>
   <tbody>
            <tr><td><%=rs.getString("ticket_no") %></td>
            <td><%=rs.getString("date") %></td>
            <td><%=rs.getString("from1") %></td>
            <td><%=rs.getString("to1") %></td>
            <td><%=rs.getString("busno") %></td>
            <td> <%=rs.getString("seatno") %></td>
            <td><a href='show_ticket.jsp?t=<%=rs.getString("ticket_no") %>' class="button-grad-purple">Show</a></td>
            <td><a href='ticket_cancel.jsp?u=<%=rs.getString("ticket_no") %>' class="button-grad-purple">Cancel</a></td>
