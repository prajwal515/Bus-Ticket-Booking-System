...
<!--    <script>
    ...
    <body  id="page-top" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <div class="col-lg-12 col-md-5 col-lg-offset-5 col-sm-12 col-sm-offset-12">
                 <form method="post" action="admin_login2.jsp">
                      ...
                      <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-6">
                             <button type="submit" class="button-3d button-lg button-pasific hover-ripple-out mt20 ml20 center-block" >Login</button>
