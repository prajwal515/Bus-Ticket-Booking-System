...
<!--                            <small class="heading-desc text-lowercase">
                 ...
                 <div class="row mt20">
                    <form  method="post" action="book_bus2.jsp">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="busname"  class="input-rounded" style="background-color: #f1f1f8;" value='<%=res.getString("busname")%>' readonly>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">                            
                            <div class="form-group">
                               ...
                               <input type="time" class="input-rounded" id="appt" name="dtime" style="background-color: #f1f1f8;" value='<%=res.getString("dtime")%>' readonly>
                            </div>
                        </div>
                        </div>
                        <!-- dob end -->
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">                            
                            <div class="form-group">
                                <label><b>Arrival time:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <input type="time" class="input-rounded" id="appt" style="background-color: #f1f1f8;" name="atime" value='<%=res.getString("atime")%>' readonly>
                            </div>
                        </div>
                        </div>
                        <!--  age start -->
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="from" class="input-rounded "  style="background-color: #f1f1f8;  " value='<%=res.getString("fromstop")%>' readonly>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">                            
                            <div class="form-group">
                                <label><b>To:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </label>
                                <input type="text" name="to" class="input-rounded" style="background-color: #f1f1f8;" value='<%=res.getString("tostop")%>' readonly>
                            </div>
                        </div>
                        </div>
                        <!-- student end -->
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="distance"  class="input-rounded" style="background-color: #f1f1f8;" value='<%=res.getString("distance")%>' readonly>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="chargeamount"  class="input-rounded" style="background-color: #f1f1f8;" value='<%=res.getString("chargeamount")%>' readonly>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="date" style="background-color: #f1f1f8;" class="input-rounded" value="<%=date1%>" readonly>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            <div class="form-group">
                                ...
                                <select name="seats" size="0" required>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-9">
                             ...
                             <div class="col-md-2 col-sm-10 col-xs-12 text-center">
                                 <button type="submit"  class="button-3d button-lg button-pasific hover-ripple-out mt20 center-block">BOOK</button>
                        </div>
