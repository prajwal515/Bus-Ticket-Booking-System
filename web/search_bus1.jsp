...
<table class="table">
   ...
   try
   {
       ...
       PreparedStatement ps = conn.prepareStatement("select * from bus where fromstop=? and tostop=?" );
            ps.setString(1,from);
            ps.setString(2,to);
   ...
   <tbody>
            ...
            <td><center><a href='seat_avai.jsp?u=<%=rs.getString("busno") %>' class="button-grad-purple">Book Ticket</a></center></td>
